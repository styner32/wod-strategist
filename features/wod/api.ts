...
// TODO: Replace with your machine's IP if running on physical device or Android Emulator (10.0.2.2)
// const API_BASE_URL = "https://wod-strategist-api-dev-h2mlnko75q-du.a.run.app/api/v1";
const API_BASE_URL = "http://192.168.219.137:8088/api/v1";
// TODO: Securely manage this key (e.g., via env vars in EAS Build)
// const API_SECRET_KEY = "ec4fb2cc0a4a61471f4efe6229a8f676";
const API_SECRET_KEY = "test-api-key";
